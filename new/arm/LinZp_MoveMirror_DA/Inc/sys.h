...
#define DIR0                         HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7, GPIO_PIN_RESET)//???
#define DIR1                         HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7, GPIO_PIN_SET)

#define ValidDisable                 HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_RESET)//???
#define ValidEnable                  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_SET)
