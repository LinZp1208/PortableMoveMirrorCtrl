...
#define SHT_DAT GPIO_PIN_7

#define SHT_SCK_1 HAL_GPIO_WritePin(GPIOB, SHT_SCK, GPIO_PIN_SET) //SHT_SCK=1
#define SHT_SCK_0 HAL_GPIO_WritePin(GPIOB, SHT_SCK, GPIO_PIN_RESET)//SHT_SCK=0

#define SHT_DAT_OUT SetDataOut() //数据输出
#define SHT_DAT_IN SetDataIn() //数据输入
#define SHT_DAT_1 HAL_GPIO_WritePin(GPIOB,SHT_DAT, GPIO_PIN_SET) //SHT_DAT=1
#define SHT_DAT_0 HAL_GPIO_WritePin(GPIOB,SHT_DAT, GPIO_PIN_RESET) //SHT_DAT=0

#define Read_SHT_Dat HAL_GPIO_ReadPin(GPIOB,SHT_DAT)
